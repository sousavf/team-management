...
# Team Management System v1.6.0 Multi-Platform Build and Push Script
...
if [ "$DOCKER_USERNAME" = "your-docker-username" ]; then
    ...
    echo "or run: DOCKER_USERNAME=your-username ./build-v1.6.sh"
    exit 1
fi
...
BUILDER_NAME="team-management-v1.6-builder"
...
echo ""
echo "🆕 What's new in v1.6.0:"
echo "   - Email notifications for time-off requests"
